  ...
  resolve: {
    alias: {
      ...
      "openp41ge-uikit/git-repository": path.resolve(
        __dirname,
        "./packages/openp41ge-uikit/src/git-repository",
      ),
      "openp41ge-uikit": path.resolve(__dirname, "./packages/openp41ge-uikit/src"),
      "openp41ge-scrollbar": path.resolve(__dirname, "./packages/openp41ge-scrollbar/src"),
      "openp41ge-filesystem": path.resolve(__dirname, "./packages/openp41ge-filesystem/src"),
      "openp41ge-constants": path.resolve(__dirname, "./packages/openp41ge-constants/src"),
      "openp41ge-logger": path.resolve(__dirname, "./packages/openp41ge-logger/src"),
      "openp41ge-terminal": path.resolve(__dirname, "./packages/openp41ge-terminal/src"),
      "openp41ge-agents": path.resolve(__dirname, "./packages/openp41ge-agents/src"),
