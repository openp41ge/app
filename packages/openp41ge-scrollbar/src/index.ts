...
// ─── OverlayScrollbar (floating overlay scrollbar) ──────────────────────
// Implemented in its own module (single class per file). Re-exported here so
// the package's public entry surface is unchanged.
