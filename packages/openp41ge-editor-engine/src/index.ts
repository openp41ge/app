/**
 * openp41ge-editor-engine — Pure engine logic for the file editor.
 *
 * Contains model, view, cursor, input, rendering, themes, and services.
 * Does not include the Lit web component (<file-editor>) — that lives in
 * openp41ge-uikit (src/components/file-editor/) and imports from this package.
 */
