...
export class Openp41geProjectPicker extends LitElement {
  static styles = css`
    ...
    .detail-card .repo-tree .repo-item {
      padding: 5px 0;
    }

    .detail-card .repo-tree .repo-label {
      font-size: 13px;
      color: var(--openp41ge-text-color, #e0e0e0);
      display: flex;
      align-items: center;
    ...
    .detail-card .repo-tree .worktree-list {
      list-style: none;
      margin: 2px 0 0 22px;
      padding: 0;
    }

    .detail-card .repo-tree .worktree-list li {
      padding: 2px 0;
      font-size: 12px;
      color: var(--openp41ge-muted-text, #888);
      display: flex;
    ...
    .detail-card .repo-tree .worktree-icon {
      width: 12px;
      height: 12px;
      flex-shrink: 0;
      color: #e5c07b;
                                          ...
                                          ? html`
                                              <ul class="worktree-list">
                                                ${repo.worktrees.map(
                                                  (wt) => html`
                                                    <li>
                                                      <svg class="worktree-icon" viewBox="0 0 16 16" fill="currentColor">
